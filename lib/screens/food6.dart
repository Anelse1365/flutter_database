...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final List<Map<String, dynamic>> foods = [
    ...
    {
      'name': 'กล้วยหอม (1 ลูก)',
      'image': 'assets/Fruits_Vegetables/2_banana.jpg',
      'calories': 96,
      'fat': 0,
      'protein': 18,
    },
    {
      'name': 'แตงโม (1 ชิ้น)',
      'image': 'assets/Fruits_Vegetables/3_watermalon.jpg',
      'calories': 30,
      'fat': 0.2,
      'protein': 0.6,
    },
    {
      'name': 'แอปเปิ้ล (1 ชิ้น)',
      'image': 'assets/Fruits_Vegetables/4_apple.jpg',
      'calories': 57,
      'fat': 0.1,
      'protein': 0.3,
    },
    {
      'name': 'อุง่น (1 พวง)',
      'image': 'assets/Fruits_Vegetables/5_graves.jpg',
      'calories': 67,
      'fat': 0,
      'protein': 0.6,
    },
    {
      'name': 'มังคุต (1 ลูก)',
      'image': 'assets/Fruits_Vegetables/6_mangosteen.jpg',
      'calories': 60,
      'fat': 0.40,
      'protein': 0.60,
    },
